...
if __name__ == '__main__':
    ...
    args['log'] = '21-bench' # where to save your result
    args['model'] = 'logistic' # model
    N = int(args['num_clients'])
    C = [50.0] * N # cost
    args['budget'] = 200.0
    v = np.random.exponential(scale=5000,size=40)
    ...
    for time_seed in range(0,1):
        ...
        for seed in range(0,15): # number of rounds to take averge
            args['sround'] = seed
