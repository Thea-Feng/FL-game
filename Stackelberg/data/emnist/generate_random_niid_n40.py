...
def main():
    ...
    num_samples = np.random.lognormal(4, 3, (NUM_USER)) + 80
    ...
    for user in range(NUM_USER):
        if NIID[0] == NIID[1]:
            ...
            if num_samples[user] < 100:
                ...
                num_class = np.random.randint(8,11)
            else:
    ...
    train_path = './data/train/{}_{}_N{}_v{}.json'.format(str_niid, image, NUM_USER,Version)
    test_path = './data/test/{}_{}_N{}_v{}.json'.format(str_niid, image, NUM_USER, Version)
