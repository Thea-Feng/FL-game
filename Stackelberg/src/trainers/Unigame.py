...
class UnigameTrainer(BaseTrainer):
    ...
    def __init__(self, options, dataset):
        ...
        super(UnigameTrainer, self).__init__(options, dataset, worker=worker)
    ...
    def compute_prob(self, duipai=False):
        # here is real
        print('compute qk uniform')
        sum = 0
        for c in self.logDict['ck']:
            sum += (1/c)
