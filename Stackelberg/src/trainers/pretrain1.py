...
class Pretrain1Trainer(BaseTrainer):
    ...
    def __init__(self, options, dataset):
        ...
        super(Pretrain1Trainer, self).__init__(options, dataset, worker=worker)
    ...
    def train(self, initq):
        
        # Get grad_norm
        prob = [initq] * self.numOfClients
        self.prob = prob
        ...
        for i, c in enumerate(self.clients):
            ...
            # self.logDict['Pk'].append(2*c.ck*c.qk-c.vk/R*(c.pk**2)*(c.Gk**2)/(c.qk**2))
        ...
        for round_i in range(self.num_round):
            ...
            self.logDict['gk'].append([c.Gk for c in self.clients])
            if self.isSysHeter:
