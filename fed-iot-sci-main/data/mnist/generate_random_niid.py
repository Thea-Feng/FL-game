...
def main():
    ...
    for user in range(NUM_USER):
        if NIID[0] == NIID[1]:
            ...
            # num_class = np.random.randint(NIID[0],NIID[1])
    ...
    train_path = './data/train/{}_{}.json'.format(str_niid, image)
    test_path = './data/test/{}_{}.json'.format(str_niid, image)
