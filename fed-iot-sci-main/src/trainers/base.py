...
from src.utils.file_utils import convert_dict_2_json
...
class BaseTrainer(object):
    def __init__(self, options, trainerConfig):
        ...
        '''
            ...
            * TS time seed
        '''
        if  options['algo'] == 'bing_s2':
            self.file_name = "T{}.DS{}.AG{}t{}.E{}.K{}.R{}.SD{}.TS{}.json".format(options['test_num'], options['dataset'], options['algo'], options['update_fre'],options['num_epoch'], options['clients_per_round'], options['num_round'], options['seed'],options['time_seed'])
        else:    
            self.file_name = "T{}.DS{}.AG{}.E{}.K{}.R{}.SD{}.TS{}.json".format(options['test_num'], options['dataset'], options['algo'], options['num_epoch'], options['clients_per_round'], options['num_round'], options['seed'],options['time_seed'])
    ...
    def test_latest_model_on_traindata(self, round_i):
        ...
        self.log_round_loss = stats_from_train_data['loss']
        return global_grads
